...
axios.defaults.baseURL = process.env.baseURL || process.env.apiUrl || 'https://lisensi.ruasdigital.com';
...
let config = {
  baseURL: process.env.baseURL || process.env.apiUrl || "https://lisensi.ruasdigital.com/",
