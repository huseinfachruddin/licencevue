...
axios.defaults.baseURL = process.env.baseURL || process.env.apiUrl || 'https://lisensi.kawanmama.com';
...
let config = {
  baseURL: process.env.baseURL || process.env.apiUrl || "https://lisensi.kawanmama.com/",
